...
public class RestUtilities {
	...
	public static RequestSpecification getRequestSpecification() {
		...
		AuthenticationScheme authenticationScheme = RestAssured.oauth(Auth.CONSUMER_KEY, Auth.CONSUMER_SECRET, Auth.ACCESS_TOKEN, Auth.ACCESS_SECRET);
	...
	public static RequestSpecification createQuaryParam(RequestSpecification rspec, String param, String value ) {
		
		return rspec.queryParam(param, value);
	
	}
	public static RequestSpecification createQuaryParam(RequestSpecification rspec, Map<String,String> queryMap) {
